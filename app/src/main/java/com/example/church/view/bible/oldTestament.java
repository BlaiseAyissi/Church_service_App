...
public class oldTestament extends AppCompatActivity implements RecyclerViewInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView = findViewById(R.id.recyclerOT);
        searchView = findViewById(R.id.searchOT);
    ...
    public void fetchdata(String value){
        ...
        try{
            ...
            while (line != null && !line.contains("Matthieu")) {
    ...
    public void onItemClick(int position) {
        try{
            ...
            Intent intent = new Intent(oldTestament.this, bChapters.class);
